...
void GraphicsPipeline::initialize(const VkDevice& device, const SwapChain& swapChain) {
...
void GraphicsPipeline::createRenderPass(const VkDevice& device, const SwapChain& swapChain) {
...
void GraphicsPipeline::createGraphicsPipeline(const VkDevice& device) {
	...
	pipelineInfo.pStages = m_MachineShader.getShaderStages().data();//same
	VkPipelineVertexInputStateCreateInfo vertexInputInfo = m_MachineShader.createVertexInputStateInfo();
...
void GraphicsPipeline::createFrameBuffers(const VkDevice& device, const SwapChain& swapChain) {
	m_SwapChainFramebuffers.resize(swapChain.getSwapChainImageViews().size());
